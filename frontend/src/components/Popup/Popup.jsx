            ...
            <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-4 shadow-md bg-white rounded-md duration-200 w-[300px]">
                ...
                <div className="mt-4">
                    ...
                    <input 
                      ...
                      className="w-full rounded-md border border-gray-300 dark:border-500 px-2 py-1 mb-4" 
                    />

                    {/* Login button sectin */}
                    <div>
                        <button
                          className="w-full bg-primary text-white p-2 rounded-md" onClick={() => setShowPopup(false)}
                        >
                            Login
                        </button>
                    </div>
